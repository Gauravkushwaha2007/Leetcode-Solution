<h2><a href="https://leetcode.com/problems/reverse-vowels-of-a-string">10. Reverse Vowels of a String</a></h2><h3>Easy</h3><hr><p>Given a string <code>s</code>, reverse only all the vowels in the string and return it.</p>
